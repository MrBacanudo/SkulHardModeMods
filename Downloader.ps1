...
Invoke-WebRequest -URI "https://github.com/MrBacanudo/SkulHardModeMods/releases/download/HardModeModPack-v0.0.3/AllMods.zip" -OutFile $download_folder/modpack.zip
